...
class RemoveEXIF extends Operation {
    ...
    constructor() {
        ...
        this.module = "Image";
        this.local="";
        this.description = "Removes EXIF data from a JPEG image.<br><br>EXIF data embedded in photos usually contains information about the image file itself as well as the device used to create it.";
