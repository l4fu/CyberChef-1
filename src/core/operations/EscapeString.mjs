...
class EscapeString extends Operation {
    ...
    constructor() {
        ...
        this.module = "Default";
        this.local="";
        this.description = "转义字符串中的特殊字符,以便它们不会引起冲突。例如,<code>现在不要阻止我</code>变成了<code>现在就不要阻止我。</code><br><br>支持以下转义序列：<ul><li><code>00n</code>（换行/换行）</li><li><code><r</code>（回车）</li><li><code>00t</code>（水平制表符）</li><li>><code>00b</code>（退格）</李><li><code>0f</code>（换行）<li<li><code><xnn</code>（十六进制,其中n为0-f）</>000</code>（反斜杠）</li><li><code>00'</code>（单引号）</li><li><code>00</code>（双引号）</li><li><code>00unnn</code>（Unicode字符）</li><li><code>00 u{nnnn}</code>（Unicode码点）</li></ul>Escapes special characters in a string so that they do not cause conflicts. For example, <code>Don't stop me now</code> becomes <code>Don\\'t stop me now</code>.<br><br>Supports the following escape sequences:<ul><li><code>\\n</code> (Line feed/newline)</li><li><code>\\r</code> (Carriage return)</li><li><code>\\t</code> (Horizontal tab)</li><li><code>\\b</code> (Backspace)</li><li><code>\\f</code> (Form feed)</li><li><code>\\xnn</code> (Hex, where n is 0-f)</li><li><code>\\\\</code> (Backslash)</li><li><code>\\'</code> (Single quote)</li><li><code>\\&quot;</code> (Double quote)</li><li><code>\\unnnn</code> (Unicode character)</li><li><code>\\u{nnnnnn}</code> (Unicode code point)</li></ul>";
