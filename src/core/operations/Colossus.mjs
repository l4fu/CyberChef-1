...
class Colossus extends Operation {
    ...
    constructor() {
        ...
        this.local="";
        this.description = "巨像是世界上第一台电子计算机的名字。1943年第二次世界大战期间，托米·弗劳尔斯（Tommy Flowers）设计了十座巨像，并在多利斯山（Dollis Hill）的邮局研究实验室建造。这些巨像协助破译了德国洛伦兹密码附件（德语：Lorenz cipher attachment），这是一台用来加密希特勒与前线将军之间通信的机器<br><br>要了解更多信息，请访问<a href='https://virtualcolossus.co.uk'target='_blank>virtualclossus.co.uk</a><br><br>有关此操作的详细说明，请参见<A href='https://github.com/gchq/CyberChef/wiki/Colossus“target=”_blank>，此处为</a>。Colossus is the name of the world's first electronic computer. Ten Colossi were designed by Tommy Flowers and built at the Post Office Research Labs at Dollis Hill in 1943 during World War 2. They assisted with the breaking of the German Lorenz cipher attachment, a machine created to encipher communications between Hitler and his generals on the front lines.<br><br>To learn more, Virtual Colossus, an online, browser based simulation of a Colossus computer is available at <a href='https://virtualcolossus.co.uk' target='_blank'>virtualcolossus.co.uk</a>.<br><br>A more detailed description of this operation can be found <a href='https://github.com/gchq/CyberChef/wiki/Colossus' target='_blank'>here</a>.";
