...
class ToSnakeCase extends Operation {
    ...
    constructor() {
        ...
        this.module = "Code";
        this.local="";
        this.description = "将输入字符串转换为snake大小写。<br><br>大小写都是小写，以下划线作为单词边界。<br><br>.g.this_is_snake_case<br><br>“尝试上下文感知”将使操作尝试很好地转换变量和函数名。Converts the input string to snake case.<br><br>Snake case is all lower case with underscores as word boundaries.<br><br>e.g. this_is_snake_case<br><br>'Attempt to be context aware' will make the operation attempt to nicely transform variable and function names.";
