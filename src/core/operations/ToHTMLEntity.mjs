...
class ToHTMLEntity extends Operation {
    ...
    constructor() {
        ...
        this.local="";
        this.description = "将字符转换为HTML实体<br><br>，例如<code>&amp</代码>变为<code>&amp<span>amp</span></code>Converts characters to HTML entities<br><br>e.g. <code>&amp;</code> becomes <code>&amp;<span>amp;</span></code>";
