...
class Zip extends Operation {
    ...
    constructor() {
        ...
        this.local="";
        this.description = "使用给定文件名使用PKZIP算法压缩数据<br><br>此时不支持多个文件。Compresses data using the PKZIP algorithm with the given filename.<br><br>No support for multiple files at this time.";
