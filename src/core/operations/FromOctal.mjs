...
class FromOctal extends Operation {
    ...
    constructor() {
        ...
        this.module = "Default";
        this.local="";
        this.description = "将八进制字节字符串转换回其原始值。<br><br>例如，<code>316 223 316 265 316 271 316 254 40 317 203 316 277 317 205</code>成为UTF-8编码字符串<code>εConverts an octal byte string back into its raw value.<br><br>e.g. <code>316 223 316 265 316 271 316 254 40 317 203 316 277 317 205</code> becomes the UTF-8 encoded string <code>Γειά σου</code>";
