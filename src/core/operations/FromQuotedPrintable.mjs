...
class FromQuotedPrintable extends Operation {
    ...
    constructor() {
        ...
        this.module = "Default";
        this.local="";
        this.description = "将QP编码文本转换回标准文本。<br><br>例如,引用的可打印编码字符串<code>hello=20world</code>变为<code>hello world</code>Converts QP-encoded text back to standard text.<br><br>e.g. The quoted-printable encoded string <code>hello=20world</code> becomes <code>hello world</code>";
