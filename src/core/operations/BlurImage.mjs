...
class BlurImage extends Operation {
    ...
    constructor() {
        ...
        this.module = "Image";
        this.local="";
        this.description = "将模糊效果应用于图像<br><br>高斯模糊比快速模糊慢得多，但效果更好。Applies a blur effect to the image.<br><br>Gaussian blur is much slower than fast blur, but produces better results.";
