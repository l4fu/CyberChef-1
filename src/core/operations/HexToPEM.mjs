...
class HexToPEM extends Operation {
    ...
    constructor() {
        ...
        this.local="";
        this.description = "将十六进制DER（区分编码规则）字符串转换为PEM（隐私增强邮件）格式。Converts a hexadecimal DER (Distinguished Encoding Rules) string into PEM (Privacy Enhanced Mail) format.";
