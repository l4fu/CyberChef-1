...
class VigenèreDecode extends Operation {
    ...
    constructor() {
        ...
        this.module = "Ciphers";
        this.local="";
        this.description = "维格纳密码是一种基于关键字字母使用一系列不同的凯撒密码对字母文本进行加密的方法。这是一种简单的多羟基取代形式。The Vigenere cipher is a method of encrypting alphabetic text by using a series of different Caesar ciphers based on the letters of a keyword. It is a simple form of polyalphabetic substitution.";
