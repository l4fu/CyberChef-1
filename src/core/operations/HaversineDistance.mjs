...
class HaversineDistance extends Operation {
    ...
    constructor() {
        ...
        this.module = "Default";
        this.local="";
        this.description = "返回两对GPS纬度和经度坐标之间的距离，单位为米。<br><br>例如，<code>51.487263，-0.124323，38.9517，-77.1467</code>Returns the distance between two pairs of GPS latitude and longitude co-ordinates in metres.<br><br>e.g. <code>51.487263,-0.124323, 38.9517,-77.1467</code>";
