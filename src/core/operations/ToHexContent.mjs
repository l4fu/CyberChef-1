...
class ToHexContent extends Operation {
    ...
    constructor() {
        ...
        this.module = "Default";
        this.local="";
        this.description = "将字符串中的特殊字符转换为十六进制。SNORT使用此格式表示ASCII文本中的十六进制。<br><br>例如，<code>foo=bar</code>变为<code>foo|3d| bar</code>。Converts special characters in a string to hexadecimal. This format is used by SNORT for representing hex within ASCII text.<br><br>e.g. <code>foo=bar</code> becomes <code>foo|3d|bar</code>.";
