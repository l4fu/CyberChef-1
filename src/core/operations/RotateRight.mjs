...
class RotateRight extends Operation {
    ...
    constructor() {
        ...
        this.module = "Default";
        this.local="";
        this.description = "将每个字节向右旋转指定的位数，可选地将多余的位转移到下一个字节。目前仅支持8位值。Rotates each byte to the right by the number of bits specified, optionally carrying the excess bits over to the next byte. Currently only supports 8-bit values.";
