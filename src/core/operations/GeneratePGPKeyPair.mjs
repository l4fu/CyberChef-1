...
class GeneratePGPKeyPair extends Operation {
    ...
    constructor() {
        ...
        this.module = "PGP";
        this.local="";
        this.description = "生成新的公共/私有PGP密钥对。支持RSA和椭圆曲线（EC）密钥。<br><br>Generates a new public/private PGP key pair. Supports RSA and Eliptic Curve (EC) keys.<br><br>"+`${cryptNotice}`;
