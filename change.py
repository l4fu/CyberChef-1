...
mark_url=u"E:/star_git项目/CyberChef/CyberChef-2/src/core/operations"
...
#         # else:    
#             # 替换文件内容 为 翻译后的内容
#             lo='this.description = \"{}'.format(xx).replace("\\", "0").replace("，", ",")
#             print(lo)
